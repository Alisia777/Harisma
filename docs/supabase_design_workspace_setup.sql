...
begin
  ...
  insert into public.portal_design_workspace_audit
    (brand, revision, event_type, summary, metadata, actor_id)
  values (
    p_brand,
    next_revision,
...
begin
  ...
  insert into public.portal_design_workspace_audit
    (brand, revision, event_type, summary, metadata, actor_id)
  values (p_brand, next_revision, 'workspace.restore', summary_text, jsonb_build_object('restored_revision', p_revision), auth.uid());
