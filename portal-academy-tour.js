(function () {
  ...
  var VIEW_GUIDES = {
    ...
    repricer: {
      ...
      actions: [
        'Нажмите «1. Скачать рабочий Excel», заполните слева маржу, MIN/MAX, статус или точечную цену и сохраните файл.',
        'Нажмите «2. Загрузить заполненный Excel» и выберите тот же файл. Пустые поля ничего не меняют.',
