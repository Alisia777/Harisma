(function () {
  ...
  const EXPECTED_VERSION = '20260701-dashboard-money-orders3';
  const SCRIPT_URL = `portal-dashboard-ceo-motion-v1.js?v=20260701dashboard-money-orders3-force&ts=${Date.now()}`;
