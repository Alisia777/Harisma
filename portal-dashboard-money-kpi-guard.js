(function () {
  ...
  const EXPECTED_VERSION = '20260701-dashboard-money-rub4';
  const SCRIPT_URL = `portal-dashboard-ceo-motion-v1.js?v=20260701dashboard-money-rub4-force&ts=${Date.now()}`;
