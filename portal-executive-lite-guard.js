(function () {
  if (window.__ALTEA_EXECUTIVE_LITE_GUARD_20260516_EXECLEAN4__) return;
  window.__ALTEA_EXECUTIVE_LITE_GUARD_20260516_EXECLEAN4__ = true;

  const VERSION = '20260516execlean4';
