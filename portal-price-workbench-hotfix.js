(function () {
  if (window.__ALTEA_PRICE_WORKBENCH_LOADER_20260420O__) return;
  window.__ALTEA_PRICE_WORKBENCH_LOADER_20260420O__ = true;

  const SCRIPT_ID = "portalPriceWorkbenchHotfixRuntime";
  const BUNDLE_PARTS = [
    "portal-price-workbench.runtime.gz.part01.txt?v=20260420o",
    "portal-price-workbench.runtime.gz.part02.txt?v=20260420o",
    "portal-price-workbench.runtime.gz.part03.txt?v=20260420o",
    "portal-price-workbench.runtime.gz.part04.txt?v=20260420o"
  ];
