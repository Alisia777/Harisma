(function () {
  ...
  var VIEW_META = {
    ...
    "product-leaderboard": {
      eyebrow: "КЗ leaderboard",
      title: "Сначала уровень недели, затем план-факт модули и SKU race.",
      text: "Экран теперь читает КЗ как игровой скор: трафик, корзина, выкуп, экономика и owner coverage сразу показывают, где масштабировать, а где разбирать риск.",
  ...
  function rewriteViewCopy(root, viewKey) {
    ...
    if (viewKey === "product-leaderboard") {
      setText(root, ".section-title p", "КЗ leaderboard с игровым уровнем недели: сверху скор, план-факт модули и owner race, ниже SKU с охватами, продажами, экономикой и рисками.");
      return;
    }
    if (viewKey === "prices") {
