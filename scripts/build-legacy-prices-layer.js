...
function buildLegacyRow(row = {}, platform = '', supportRow = null, ownerOverride = '') {
  ...
  return {
    ...
    manualMarginPct: firstNumber(row?.manualMarginPct, row?.targetMarginPct, row?.allowedMarginPct),
    targetMarginPct: firstNumber(row?.targetMarginPct, row?.manualMarginPct, row?.allowedMarginPct),
    allowedMarginPct: firstNumber(row?.manualMarginPct, row?.targetMarginPct, row?.allowedMarginPct),
    marginSource: row?.marginSource || row?.minMaxSource || '',
