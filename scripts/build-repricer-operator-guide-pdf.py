...
def build_story():
    ...
    story += [
        ...
        step(
            ...
            "На вкладке «Репрайсер» нажмите «Получить актуальные цены». Дождитесь нового "
        ...
        data_table(
            [
                ...
                ["1", "Индивидуальная маржа SKU", "Цена ниже floor не предлагается"],
                ["2", "MIN", "Цена поднимается до допустимого минимума"],
                ["3", "MAX", "Ограничивает цену, но не может нарушить маржу"],
    ...
    story += [
        ...
        callout(
            "Ответ коротко",
            "Во вкладке «Маржа_MIN_MAX» колонка «Маржа, %» находится самой первой слева. "
            "Для каждой SKU и площадки укажите целевую маржу. Допустимы 25, 25% и 0,25: "
            "все три значения трактуются как 25%.",
            "blue",
        ),
        Spacer(1, 4 * mm),
        ...
        data_table(
            [
                ["A", "B", "C", "D", "E"],
                ["Маржа, %", "articleKey", "platform", "minPrice", "maxPrice"],
            ],
        ...
        step(
            2,
            "Заполнить маржу",
            "Для active/new/relaunch не оставляйте пустых значений. Значение должно быть больше "
            "0% и меньше 100%.",
        ),
        step(
            3,
